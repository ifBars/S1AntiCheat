...
internal static class AdmissionPolicy
{
        ...
        bool failClosedWhenLobbyUnavailable)
    {
        ...
        {
            return new AdmissionDecision(true, AdmissionReason.LocalHost, localSteamId);
        }
        ...
        bool isCurrentLobbyMember = lobbyMemberIds.Any(
            memberId => TryParseSteamId(memberId, out ulong memberSteamId) && memberSteamId == steamId);
